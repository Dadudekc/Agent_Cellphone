...
class AgentPanel(QWidget):
    ...
    def init_ui(self):
        ...
        layout.setContentsMargins(15, 15, 15, 15)  # Smaller margins for 4 panels
        ...
        # Control buttons with tooltips (compact for 4 panels)
        controls = [
    ...
    def update_status(self, status: str, task: str = None, last_update: str = None):
        ...
        self.update_label.setText(f"Updated: {self.last_update}")
